...
public class OperationServiceImpl implements IOperationService {
    ...
    private int getBaseCostAndValidate(String operationCode) {
    ...
    public CreditExecutionResponse calculateCredit(CreditExecutionRequest request, User user) {
        int baseCost = getBaseCostAndValidate("OP-01");
        ...
        int cost = operationEstimator.estimateCost(baseCost, request, response);
        tokenConsumptionStrategy.consumeTokens(user, cost, "OP-01 Credit Installments");
    ...
    public CurrencyConverterResponse convertCurrency(CurrencyConverterRequest request, User user) {
        int baseCost = getBaseCostAndValidate("OP-02");
        ...
        int cost = operationEstimator.estimateCost(baseCost, request, response);
        tokenConsumptionStrategy.consumeTokens(user, cost, "OP-02 Currency Converter");
    ...
    public BMIResponse calculateBMI(BMIRequest request, User user) {
        int baseCost = getBaseCostAndValidate("OP-03");
        ...
        int cost = operationEstimator.estimateCost(baseCost, request, response);
        tokenConsumptionStrategy.consumeTokens(user, cost, "OP-03 BMI Calculator");
    ...
    public SleepResponse calculateSleep(SleepRequest request, User user) {
        int baseCost = getBaseCostAndValidate("OP-04");
        ...
        int cost = operationEstimator.estimateCost(baseCost, request, response);
        tokenConsumptionStrategy.consumeTokens(user, cost, "OP-04 Sleep Calculator");
